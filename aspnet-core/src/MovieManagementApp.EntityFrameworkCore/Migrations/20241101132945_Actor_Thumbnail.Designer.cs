...
namespace MovieManagementApp.Migrations
{
    ...
    [Migration("20241101132945_Actor_Thumbnail")]
    partial class Actor_Thumbnail
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieManagementApp.Actors.Actor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ActorImageBlob")
                    ...
                    b.ToTable("AppActors", (string)null);
                });

            modelBuilder.Entity("MovieManagementApp.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieManagementApp.MovieActors.MovieActor", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMovieActors", (string)null);
                });
            ...
            modelBuilder.Entity("MovieManagementApp.Movies.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MovieBlob")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PosterBlob")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MovieManagementApp.MyAccounts.MyAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieManagementApp.MyLists.MyList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppMyLists", (string)null);
                });

            modelBuilder.Entity("MovieManagementApp.Ratings.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieManagementApp.UserMovieInteractions.UserMovieInteraction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppUserMovieInteractions", (string)null);
                });
            ...
            modelBuilder.Entity("MovieManagementApp.MovieActors.MovieActor", b =>
                {
                    b.HasOne("MovieManagementApp.Actors.Actor", "Actor")
            ...
            modelBuilder.Entity("MovieManagementApp.MyAccounts.MyAccount", b =>
                {
                    b.HasOne("Volo.Abp.Identity.IdentityUser", null)
                        .WithOne()
                        .HasForeignKey("MovieManagementApp.MyAccounts.MyAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MovieManagementApp.MyLists.MyList", b =>
                {
                    ...
                    b.HasOne("MovieManagementApp.MyAccounts.MyAccount", "MyAccount")
                        .WithMany()
