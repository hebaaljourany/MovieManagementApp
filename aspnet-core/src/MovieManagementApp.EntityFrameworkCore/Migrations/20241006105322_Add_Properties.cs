        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppAccounts_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMovieCategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppMovieCategories_AppCategories_CategoryId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppMovieCategories_AppMovies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "AppMovies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMyLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppMyLists_AppAccounts_MyAccountId",
                        column: x => x.MyAccountId,
                        principalTable: "AppAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppMyLists_AppMovies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "AppMovies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppRatings_AppAccounts_MyAccountId",
                        column: x => x.MyAccountId,
                        principalTable: "AppAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppRatings_AppMovies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "AppMovies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserMovieInteractions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppUserMovieInteractions_AppAccounts_MyAccountId",
                        column: x => x.MyAccountId,
                        principalTable: "AppAccounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserMovieInteractions_AppMovies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "AppMovies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMovieCategories_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMovieCategories_MovieId",
                table: "AppMovieCategories",
                column: "MovieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMyLists_MovieId",
                table: "AppMyLists",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_AppMyLists_MyAccountId",
                table: "AppMyLists",
                column: "MyAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRatings_MovieId",
                table: "AppRatings",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_AppRatings_MyAccountId",
                table: "AppRatings",
                column: "MyAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserMovieInteractions_MovieId",
                table: "AppUserMovieInteractions",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_AppUserMovieInteractions_MyAccountId",
                table: "AppUserMovieInteractions",
                column: "MyAccountId");
