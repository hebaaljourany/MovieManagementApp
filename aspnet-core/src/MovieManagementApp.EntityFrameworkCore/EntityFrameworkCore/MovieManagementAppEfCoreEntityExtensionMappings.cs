...
public static class MovieManagementAppEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE MovieManagementAppModuleExtensionConfigurator CLASS (in the Domain.Shared project)
